...
const SidebarProvider = React.forwardRef(
  (
    ...
    // Side effects to manage the sidebar state.
    React.useEffect(() => {
      const handleCookie = () => {
      ...
      if (openProp === undefined) {
        const cookieValue = handleCookie();
...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 translate-x-1/2 cursor-col-resize bg-transparent transition-colors ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:-translate-x-1/2 after:bg-sidebar-border after:transition-opacity after:duration-75 hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:-left-4 sm:flex",
...
const SidebarMenuSkeleton = React.forwardRef(
  ({ className, showIcon = false, ...props }, ref) => (
    <div
      ...
      {...props}
    >
      {showIcon && <Skeleton className="flex h-4 w-4 rounded-md" />}
